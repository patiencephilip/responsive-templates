...
- New templates (portfolio, landing page, blog, docs, dashboard, etc.)
- Improvements to existing templates (accessibility, responsiveness, animations)
- Bug fixes
...
5. Open a pull request with:
   ...
   - A live demo link (GitHub Pages or CodePen)

## Code style

- Use CSS custom properties (variables) for colors and fonts
- Include a comment block at the top of the file with: template name, description, and author
